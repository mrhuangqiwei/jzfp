...
import sql.getpkhmzxx;
import sql.getpkhzzyxx;

/**
 * Servlet implementation class jzfpmzpkhxx
 */
@WebServlet("/jzfpmzpkhxx")
public class jzfpmzpkhxx extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getpkhmzxx pkhmz=new getpkhmzxx();
		String json=pkhmz.getpkhmzxx(kssj, jssj);
